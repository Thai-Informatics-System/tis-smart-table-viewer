...
import { TisSmartTableViewerComponent } from './tis-smart-table-viewer/tis-smart-table-viewer.component';
...
import { TisColumnsBtnComponent } from './tis-columns-btn/tis-columns-btn.component';
